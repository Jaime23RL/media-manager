    ...
    @else
        ...
        @if(count($episodesBySeason) > 0)
            @foreach($episodesBySeason as $season => $episodes)
                <div class="mb-6">
                    <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-3">Season {{ $season }}</h3>
                    <div class="bg-white dark:bg-gray-800 shadow overflow-hidden sm:rounded-lg">
                        <ul class="divide-y divide-gray-200 dark:divide-gray-700">
                            @foreach($episodes as $ep)
                                <li class="px-4 py-3 {{ $ep['status'] === 'have' ? 'bg-green-50 dark:bg-green-900/10' : 'bg-amber-50 dark:bg-amber-900/10' }}">
        ...
        @if(!$tmdb)
            <div class="mt-6">
                <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-3">Local Files</h3>
                <div class="bg-white dark:bg-gray-800 shadow overflow-hidden sm:rounded-lg">
                    <ul class="divide-y divide-gray-200 dark:divide-gray-700">
