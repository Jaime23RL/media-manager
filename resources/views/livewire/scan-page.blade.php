<div>
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Escaneo de Series</h1>
        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
            Escanea tus carpetas de anime para detectar series y archivos de video.
        </p>
    </div>
    ...
    <div class="mb-6">
        ...
        >
            ...
            <span wire:loading wire:target="scan">Escaneando...</span>
            <span wire:loading.remove wire:target="scan">Escanear Carpetas</span>
        </button>
    </div>
    ...
    <div wire:loading wire:target="scan" class="mb-6">
        <div class="flex items-center text-indigo-600">
            ...
            <span>Escaneando carpetas de series...</span>
        </div>
    </div>
        ...
        <div class="bg-white dark:bg-gray-800 shadow overflow-hidden sm:rounded-lg">
            <div class="px-4 py-5 sm:px-6 border-b border-gray-200 dark:border-gray-700">
                <h3 class="text-lg leading-6 font-medium text-gray-900 dark:text-white">
                    Series encontradas ({{ count($series) }})
                </h3>
            </div>
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    ...
                                    <div class="text-sm text-gray-500 dark:text-gray-400">
                                        {{ $serie['file_count'] }} archivos · {{ $serie['type'] === 'anime' ? 'Anime' : 'Película' }}
                                    </div>
                                </div>
                            </div>
                            <div class="text-sm text-gray-500 dark:text-gray-400">
    ...
    @elseif($scanned)
        <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6 text-center">
            ...
            <h3 class="mt-2 text-sm font-medium text-gray-900 dark:text-white">No se encontraron series</h3>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                Verifica que las carpetas configuradas existan y contengan archivos de video.
            </p>
        </div>
    @endif
</div>
